...
@dataclass(frozen=True)
class BrowserConfig:viewport_width:int;viewport_height:int;device_scale:float;channel:str;executable_path:str
@dataclass(frozen=True)
class Config:
